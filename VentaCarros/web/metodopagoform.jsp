...
<div class="container">
    ...
    <form action="MetodoPago.do" method="post">
        ...
        <input type="hidden" name="idMetodo" value="<%= request.getParameter("id") %>">
        <% } %>
        <div class="mb-3">
        ...
        <div class="form-check mb-3">
            <input class="form-check-input" type="checkbox" name="inflacionApplicable" id="inflacionApplicable">
